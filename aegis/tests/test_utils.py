...
class TestUtils:
    def test_get_client_ip_for_direct_conn(self):
    ...
    def test_get_client_ip_from_x_forwarded_for_trusted(self):
        factory = RequestFactory()
        request = factory.get(
    ...
    def test_get_client_ip_from_x_forwarded_for_untrusted(self):
        factory = RequestFactory()
        request = factory.get(
