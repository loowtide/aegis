...
class TestMiddleware:
    def test_middleware_returns_403_for_blocked_ip(self):
    ...
    def test_middlware_passes_through_non_block(self):
    ...
    def test_middleware_passes_through_expired_ips(self):
    ...
    def test_middleware_tally_increment(self):
